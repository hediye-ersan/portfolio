        ...
        <div className="relative z-10 flex-1">
          {isJobCraft ? (
            <button
              ...
              className={`relative z-10 flex items-center justify-center gap-2 py-3 text-sm font-medium transition-colors duration-300 w-full ${
                ...
                {showTooltip && (
                  ...
                  >
                    <div className="relative">
                      {/* Tooltip content */}
                      <div className="bg-black/85 backdrop-blur-md text-white px-5 py-3 rounded-xl text-sm font-medium max-w-sm text-center shadow-xl border border-white/10">
                        {tooltipMessage}
                      </div>
                      {/* Tooltip arrow */}
                      <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-1">
                        <div className="w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[8px] border-t-black"></div>
                      </div>
                    </div>
                  </motion.div>
                )}
